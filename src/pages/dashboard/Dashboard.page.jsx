...
const DashboardNavBar = () => {
  ...
  useEffect(()=>{
    axios.get("/messages/unread-amount")
    .then(({data})=>{
  ...
  return (
    <Fragment>
        ...
        <ul className="nav nav-tabs">
          ...
          <li className="nav-item">
            <NavLink className="nav-link" to="/admin/dashboard/messages">
              הודעות {amount && <span className="bg-secondary p-1 rounded me-1 text-light">{amount}</span>}
            </NavLink>
          </li>
          <li className="nav-item">
      ...
      <div className="py-4">
        ...
        {location.pathname.includes("messages") && <AdminMessages onMessageRead={messageRead} />}
